...
rl.question('Ingrese la calificación numérica (0-100): ', function (calificacion) {
  // Convertir la entrada a número decimal
  var nota = parseFloat(calificacion);
  var letra; // Variable para almacenar la calificación en letra
  ...
  if (nota < 0 || nota > 100) {
    ...
    var rango = Math.floor(nota / 10); // Estructura Switch para evaluar el rango de la calificación

    switch (rango) {
      case 10: // Caso especial para 100

      case 9:
        // Para calificaciones 90-99
        letra = 'A';
        break;

      case 8:
        // Para calificaciones 80-89
        letra = 'B';
        break;

      case 7:
        // Para calificaciones 70-79
        letra = 'C';
        break;

      case 6:
        // Para calificaciones 60-69
        letra = 'D';
        break;

      default:
        // Para calificaciones 0-59
        letra = 'F';
