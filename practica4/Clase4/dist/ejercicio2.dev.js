...
rl.question('Ingrese el primer número: ', function (num1) {
  ...
  rl.question('Ingrese el segundo número: ', function (num2) {
    ...
    rl.question('Ingrese el operador (+, -, *, /): ', function (operador) {
      ...
      switch (operador) {
        case '+':
          // Si el operador es suma
          resultado = numero1 + numero2;
          console.log(numero1 + ' + ' + numero2 + ' = ' + resultado);
          break;

        case '-':
          // Si el operador es resta
          resultado = numero1 - numero2;
          console.log(numero1 + ' - ' + numero2 + ' = ' + resultado);
          break;

        case '*':
          // Si el operador es multiplicación
          resultado = numero1 * numero2;
          console.log(numero1 + ' * ' + numero2 + ' = ' + resultado);
          break;

        case '/':
          // Si el operador es división
